...
TIP: 标签是一个键 / 值对，您可以将其分配给 Kubernetes 对象进行标识。通过标签，可以更轻松地对 Kubernetes 对象进行排序，组织和查找。要了解有关 Kubernetes 标签的更多信息， https://["请参见 Kubernetes 官方文档"^]。
...
TIP: 要了解有关 Kubernetes 标签的更多信息， https://["请参见 Kubernetes 官方文档"^]。
